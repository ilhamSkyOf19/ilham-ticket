...
export class MovieService {
  ...
  static async create(
    data: FormData
  ): Promise<ResponseType<MovieResponseType | null>> {
    // fetch with API
  ...
  //   read highlight
  static async readHighlight(): Promise<
    ResponseType<MovieHighlightResponseType[] | null>
  > {
    // call api
    const response = await api
