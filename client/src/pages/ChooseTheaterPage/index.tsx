...
const ChooseTheaterPage: FC = () => {
    ...
    return (
        <div className='w-full min-h-[100vh] flex flex-col justify-start items-start relative bg-black pt-12 gap-6'>
            ...
            {/* button continue */}
            <div className='absolute w-full flex flex-col justify-center items-center pb-4 bottom-0'>
