...
const Saldo: FC<Props> = ({ saldo, name, expired, branch }) => {
  return (
    <div className="bg-white/10 w-[92%] h-52 flex flex-col justify-between items-start rounded-4xl overflow-hidden ">
...
const KetSaldo: FC<KetSaldoProps> = ({ label, value }) => {
  return (
    <div className="flex flex-col justify-start items-start gap-1 pt-3">
      ...
      {/* value */}
      <p className="capitalize font-bold text-white text-sm ">{value}</p>
    </div>
  );
};
