...
const CardTime: FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* status */}
        <p className="text-white text-xs font-semibold text-left">{status}</p>

        {/* time */}
        <h4 className="text-white font-bold text-2xl text-left">{time}</h4>
